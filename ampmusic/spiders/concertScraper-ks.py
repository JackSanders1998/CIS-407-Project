...
class concertSpider_ad(scrapy.Spider):
    ...
    start_urls = ['https://www.mcmenamins.com/kennedy-school/gymnasium']  # contains all concert links
    ...
    def get_details(self, response: 'response object') -> dict:
        ...
        # get venues
        venue = "Gynamsium at The Kennedy School"          # hard-coded venue name (make dynamic)
        ...
        street_address_static = '5736 NE 33rd Ave.'
