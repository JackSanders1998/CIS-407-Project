...
class concertSpider_ad(scrapy.Spider):
    name = "flr"  # spider name
    # allowed domain(s) :
    # allowed_domains = ["www.mcmenamins.com"]
    start_urls = ['https://www.mcmenamins.com/old-st-francis-school/father-lukes-room']  # contains all concert links
    ...
    def get_details(self, response: 'response object') -> dict:
        ...
        # get venues
        venue = "Father Luke's Room"          # hard-coded venue name (make dynamic)
        ...
        street_address_static = '700 NW Bond Street'
