...
class concertSpider_ad(scrapy.Spider):
    name = "rct"  # spider name
    # allowed domain(s) :
    # allowed_domains = ["www.mcmenamins.com"]
    start_urls = ['https://www.mcmenamins.com/rock-creek-tavern/music-event-calendar/']  # contains all concert links
    ...
    def get_details(self, response: 'response object') -> dict:
        ...
        # get venues
        venue = "Rock Creek Tavern"          # hard-coded venue name (make dynamic)
        ...
        street_address_static = '10000 NW Old Cornelius Pass Rd.'
