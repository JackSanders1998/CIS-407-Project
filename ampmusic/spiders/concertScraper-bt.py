...
class concertSpider_ad(scrapy.Spider):
    ...
    start_urls = ['https://www.mcmenamins.com/boons-treasury/music-event-calendar/']  # contains all concert links
    ...
    def get_details(self, response: 'response object') -> dict:
        ...
        # get venues
        venue = "Boon's Treasury"          # hard-coded venue name (make dynamic)
        ...
        street_address_static = '888 Liberty St.'
